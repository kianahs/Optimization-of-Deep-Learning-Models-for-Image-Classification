...
model_name = "model-Resnet18-prebuilt-changed-BS{}-E{}-lr{}-SGD-CE-MNIST.pt".format(batch_size,num_epochs,learning_rate)
if aug == 1:
    model_name = "model-Resnet18-prebuilt-changed-BS{}-E{}-lr{}-AUG-SGD-CE-MNIST.pt".format(batch_size,num_epochs,learning_rate)
