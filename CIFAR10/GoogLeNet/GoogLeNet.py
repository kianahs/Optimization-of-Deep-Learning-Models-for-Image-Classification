...
model_name = "model-GoogLeNet-prebuilt-BS{}-E{}-lr{}-SGD-CE-CIFAR10.pt".format(batch_size,num_epochs,learning_rate)

if aug == 1:
    model_name = "model-GoogLeNet-prebuilt-BS{}-E{}-lr{}-SGD-CE-AUG-CIFAR10.pt".format(batch_size,num_epochs,learning_rate)
